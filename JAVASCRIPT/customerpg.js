(function() {
    ...
    $(document).ready(function() {
        ...
        function fetchCustomerInfo() {
            ...
            if (customerId) {
                $.ajax({
                    url: `https://firestore.googleapis.com/v1/projects/onlinestore-17c38/databases/(default)/documents/Customer/${customerId}`,
                    type: 'GET',
        ...
        $.ajax({
            url: 'https://firestore.googleapis.com/v1/projects/onlinestore-17c38/databases/(default)/documents/Inventory',
            type: 'GET',
            success: function(response) {
                    ...
                    inventoryItems.forEach(inventoryItem => {
                        ...
                        if (cartProduct) {
                            ...
                            if (newQuantity >= 0) {
                                ...
                                $.ajax({
                                    url: `https://firestore.googleapis.com/v1/projects/onlinestore-17c38/databases/(default)/documents/Inventory/${inventoryId}`,
                                    type: 'PATCH',
                                    contentType: 'application/json',
                                    data: JSON.stringify({
        ...
        function createOrder() {
            ...
            if (customerId) {
                ...
                .then(categoryNames => {
                    ...
                    $.ajax({
                        url: 'https://firestore.googleapis.com/v1/projects/onlinestore-17c38/databases/(default)/documents/Sales',
                        type: 'POST',
                        contentType: 'application/json',
